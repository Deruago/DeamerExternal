#ifndef DEAMER_EXTERNAL_CPP_TOOL_OOPSYNTAXRECOGNIZER_TYPE_INTERFACEOBJECT_H
#define DEAMER_EXTERNAL_CPP_TOOL_OOPSYNTAXRECOGNIZER_TYPE_INTERFACEOBJECT_H
...
namespace deamer::external::cpp::tool::oopsyntaxrecognizer
{
	...
	struct InterfaceObject : public Type
	{
		...
		InterfaceObject(const std::string& type_ = "");
		~InterfaceObject() override = default;
...
#endif // DEAMER_EXTERNAL_CPP_TOOL_OOPSYNTAXRECOGNIZER_TYPE_INTERFACEOBJECT_H
